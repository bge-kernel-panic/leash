...
function formatBlockMessage(label, detail, reason, cwd, analyzer, path) {
  let msg = `\u{1F6AB} ${label}: ${detail}
Reason: ${reason}
...
`;
  if (path) {
    ...
    if (suggestion) {
      msg += `Hint: This path is reachable via symlink "${suggestion}" in your working directory.
